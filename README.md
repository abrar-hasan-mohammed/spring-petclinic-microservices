...
**BRIEF ABOUT LEGACY SYSTEM :**

The Pet Clinic (PC) veterinary group has a local (on-premises) legacy (2013) application for online appointment booking. This application uses a web server installed on 4 physical servers running Linux Ubuntu Server 20.04. 

It uses another physical server running a MySQL database for data storage. 

The database contains information on: 

Veterinarians and their specialties 

Animal owners and their contact details 

Animals and their consultation appointments 

You can find the complete documentation of the application here. 

You are responsible for actively working on updating the application by applying all the DevOps methodology 


**PROPOSED SYSTEM :** 

Will be built on cloud AWS distributed architechure.  

CI / CD pipeline will be build on GitLab / Jenkins on the following environments: 

Development Path

Production  Path

initial Schema for CI / CD pipeline for each microservices :
